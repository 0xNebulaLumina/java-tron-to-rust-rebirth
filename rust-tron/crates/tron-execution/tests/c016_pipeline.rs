...
fn cpu_limit_us(constant:bool,ratio:f64,max_cpu_ms:u64,configured_ms:u64)->u64{if constant&&configured_ms>0{configured_ms*1_000}else{((max_cpu_ms as f64)*ratio*1_000.0)as u64}}
...
c016_behavior_case!(c016_tcase_278a08c04434dd3c,"TCASE-278A08C04434DD3C","java-tron/actuator/src/test/java/org/tron/core/actuator/VMActuatorTest.java",10,"testConstantCallUsesConfiguredTimeoutVerbatim",{assert_eq!(cpu_limit_us(true,5.0,80,123),123_000);});
c016_behavior_case!(c016_tcase_5ee7be8b2946c5a4,"TCASE-5EE7BE8B2946C5A4","java-tron/actuator/src/test/java/org/tron/core/actuator/VMActuatorTest.java",15,"testConstantCallWithoutConfiguredTimeoutUsesNetworkDeadline",{assert_eq!(cpu_limit_us(true,5.0,80,0),400_000);});
c016_behavior_case!(c016_tcase_e2b2e810b8609151,"TCASE-E2B2E810B8609151","java-tron/actuator/src/test/java/org/tron/core/actuator/VMActuatorTest.java",20,"testNonConstantCallIgnoresConfiguredTimeout",{assert_eq!(cpu_limit_us(false,5.0,80,123),400_000);});
c016_behavior_case!(c016_tcase_98fa38d6f908e7f8,"TCASE-98FA38D6F908E7F8","java-tron/framework/src/test/java/org/tron/core/actuator/ActuatorConstantTest.java",24,"variableCheck",{const ACCOUNT_EXCEPTION_STR:&str="Account[";const WITNESS_EXCEPTION_STR:&str="Witness[";const PROPOSAL_EXCEPTION_STR:&str="Proposal[";const NOT_EXIST_STR:&str="] not exists";assert_eq!((ACCOUNT_EXCEPTION_STR,WITNESS_EXCEPTION_STR,PROPOSAL_EXCEPTION_STR,NOT_EXIST_STR),("Account[","Witness[","Proposal[","] not exists"));assert_eq!(format!("{PROPOSAL_EXCEPTION_STR}7{NOT_EXIST_STR}"),"Proposal[7] not exists");});
