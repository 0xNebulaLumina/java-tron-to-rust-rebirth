...
fn processor(manager: SessionManager) -> TransactionProcessor { TransactionProcessor{sessions:manager,cache:cache(),pipeline:StateTransactionPipeline::new(Default::default(),ActuatorRegistry::empty(),ExecutionConfig::default()).unwrap()} }
