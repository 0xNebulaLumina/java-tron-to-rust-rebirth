...
c016_behavior_case!(c016_tcase_278a08c04434dd3c,"TCASE-278A08C04434DD3C","java-tron/actuator/src/test/java/org/tron/core/actuator/VMActuatorTest.java",10,"testConstantCallUsesConfiguredTimeoutVerbatim",{assert_eq!(Runtime::execution_deadline(true,std::time::Duration::from_millis(400),Some(std::time::Duration::from_millis(123)),false),std::time::Duration::from_millis(123));assert_eq!(Runtime::execution_deadline(true,std::time::Duration::from_millis(400),Some(std::time::Duration::from_millis(123)),true),std::time::Duration::from_millis(123));});
c016_behavior_case!(c016_tcase_5ee7be8b2946c5a4,"TCASE-5EE7BE8B2946C5A4","java-tron/actuator/src/test/java/org/tron/core/actuator/VMActuatorTest.java",15,"testConstantCallWithoutConfiguredTimeoutUsesNetworkDeadline",{assert_eq!(Runtime::execution_deadline(true,std::time::Duration::from_millis(400),None,false),std::time::Duration::from_millis(400));assert_eq!(Runtime::execution_deadline(true,std::time::Duration::from_millis(400),Some(std::time::Duration::ZERO),true),std::time::Duration::from_millis(800));});
c016_behavior_case!(c016_tcase_e2b2e810b8609151,"TCASE-E2B2E810B8609151","java-tron/actuator/src/test/java/org/tron/core/actuator/VMActuatorTest.java",20,"testNonConstantCallIgnoresConfiguredTimeout",{assert_eq!(Runtime::execution_deadline(false,std::time::Duration::from_millis(400),Some(std::time::Duration::from_millis(123)),false),std::time::Duration::from_millis(400));assert_eq!(Runtime::execution_deadline(false,std::time::Duration::from_millis(400),Some(std::time::Duration::from_millis(123)),true),std::time::Duration::from_millis(800));});
c016_behavior_case!(c016_tcase_da2f8c8cfd8d2262,"TCASE-DA2F8C8CFD8D2262","java-tron/framework/src/test/java/org/tron/core/actuator/ActuatorFactoryTest.java",62,"testCreateActuator",{let registry=ActuatorRegistry::empty();let envelope=Contract{r#type:ContractType::TransferContract as i32,parameter:Some(any("protocol.TransferContract",&TransferContract{owner_address:address(1),to_address:address(2),amount:1})),..Default::default()};assert!(registry.actuator(&envelope).is_ok());});
