...
public final class C012Oracle {
  ...
  public static void main(String[] args)throws Exception{
    if(args.length!=1)throw new IllegalArgumentException("usage: C012Oracle REQUEST.json");
    ...
    BaseTest.temporaryFolder.create();Class.forName("org.tron.core.actuator.AbstractActuator",true,C012Oracle.class.getClassLoader());Class<?> testClass=Class.forName(className,true,C012Oracle.class.getClassLoader());if(testClass.getMethod(method).getParameterCount()!=0)throw new IllegalArgumentException("test takes arguments");
    ...
    C012Capture.verify();System.out.print("C012_CAPTURE="+C012Capture.finishJson(junit)+"\n");System.out.flush();Runtime.getRuntime().halt(0);
  }
}
